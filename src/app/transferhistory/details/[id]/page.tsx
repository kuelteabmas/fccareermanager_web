...
// import { useTransferHistory } from '@/app/context/TransferHistory/TransferHistoryContext';
          ...
          <div className="">
            ...
            <div className="mt-4 grid grid-cols-6 text-center">
              <div className="">
                ...
                <p className="font-medium">{state.selectedTransaction?.playerId}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.age}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.seasonTransferWindow}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.seasonYear}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.negotiationDealDetail.dealType}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.negotiationDealDetail.loanType}</p>
              </div>
            </div>
            ...
            <div className="mt-4 grid grid-cols-6 text-center">
              <div className="">
                ...
                <p className="font-medium">{state.selectedTransaction.negotiationDealDetail.parentTeam}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.negotiationDealDetail.tempTeam}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.negotiationDealDetail.loanDurationInMonths} months</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.negotiationDealDetail.contractStartDate}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.negotiationDealDetail.contractEndDate}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.negotiationDealDetail.playerSwappedId}</p>
              </div>
            </div>
            ...
            <div className="mt-4 grid grid-cols-6 text-center">
              <div className="">
                ...
                <p className="font-medium">{state.selectedTransaction.dealFinancialsDetail.preDealWage}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.dealFinancialsDetail.postDealWage}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.dealFinancialsDetail.releaseClauseAmount}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.dealFinancialsDetail.performanceBonusType}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.dealFinancialsDetail.performanceBonusCount}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.dealFinancialsDetail.performanceBonusSum}</p>
              </div>
            </div>
            ...
            <div className="mt-4 grid grid-cols-6 text-center">
              <div className="">
                ...
                <p className="font-medium">{state.selectedTransaction.playerGrowthDetail.preDealPlayerStatus}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.playerGrowthDetail.postDealPlayerStatus}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.playerGrowthDetail.preDealPlayerOverrall}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.playerGrowthDetail.postDealPlayerOverrall}</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.playerGrowthDetail.overallGrowthPercentage}%</p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">{state.selectedTransaction.playerGrowthDetail.updatedMarketValue}</p>
              </div>
            </div>
          </div>
        </div>
